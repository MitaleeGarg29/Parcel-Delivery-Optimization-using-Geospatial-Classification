...
version = ""                       # local trained version of the model; needed for prediction and evaluation
...
if action == "train":
    ...
    test_presence_prediction = presence_prediction(
        ...
        extrapolation="none",       
        epochs=15                   # examplary value; sensical values depend on the performance of the performance of a validation split, for which large amounts of reliable data are crucial.
    )
