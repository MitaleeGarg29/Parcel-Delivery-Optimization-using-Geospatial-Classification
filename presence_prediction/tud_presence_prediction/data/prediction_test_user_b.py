...
class prediction_test_user_b(dp):
    ...
    def _process(self, loaded_raw_data, **kwargs) -> list[tuple[TensorDataset]]:
        ...
        prediction_start_date = datetime.date.fromisoformat(kwargs["date"])
        ...
        # drop everything in front of date
        main_df = main_df[main_df['datetime'].dt.date <= prediction_start_date]
        ...
        latest_date = prediction_start_date #- datetime.timedelta(days = 1)
        ...
        prediction_data = TensorDataset(x_input, x_input_additional, target.squeeze(-1)) 
    ...
    def _set_data_headers(self):
        data_headers = [
            ...
            ["Not Holiday", "Is Holiday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"],
            ["Label"]
        ]
