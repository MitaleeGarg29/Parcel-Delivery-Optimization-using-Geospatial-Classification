...
from .internal.pew_lstm_shift_2 import Pew_LSTM_shift_2
...
class LSTM_V1_Shift_2(pl.LightningModule):
    def __init__(self, in_dim, weather_dim, input_dim_3, hidden_dim=10, window_size=1, pos_weight=1, day_shift=1):
        super(LSTM_V1_Shift_2, self).__init__()

        self.day_shift = day_shift

        self.lstm = Pew_LSTM_shift_2(in_dim=in_dim, hidden_dim=hidden_dim, weather_dim=weather_dim, window_size=window_size, day_shift=day_shift)
        ...
        model_util.configure_logging(self, log_lr = False)
    ...
    def configure_optimizers(self, my_optimizer = None):
