...
class Pew_LSTM_layer_shift(nn.Module):
    def __init__(self, input_size: int, hidden_size: int, weather_size: int):
        super(Pew_LSTM_layer_shift, self).__init__()
...
class Pew_LSTM_shift(nn.Module):
    # timemode: 0 for day, 1 for week, 2 for
    def __init__(self, in_dim: int, hidden_dim: int, weather_dim: int, window_size: int = 30):
        super(Pew_LSTM_shift, self).__init__()
        self.hidden_dim = hidden_dim
        self.window_size = window_size
        self.lstm1 = Pew_LSTM_layer_shift(in_dim * window_size, hidden_dim, weather_dim * window_size)
        self.lstm2 = Pew_LSTM_layer_shift(hidden_dim, hidden_dim, weather_dim * window_size)
