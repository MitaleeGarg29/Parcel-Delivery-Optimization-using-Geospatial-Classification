...
class Pew_LSTM_layer_shift_2(nn.Module):
    def __init__(self, input_size: int, hidden_size: int, weather_size: int, day_shift=1):
        super(Pew_LSTM_layer_shift_2, self).__init__()
...
class Pew_LSTM_shift_2(nn.Module):
    ...
    def __init__(self, in_dim: int, hidden_dim: int, weather_dim: int, window_size: int = 30, day_shift=1):
        super(Pew_LSTM_shift_2, self).__init__()
        self.day_shift = day_shift
        self.hidden_dim = hidden_dim
        self.window_size = window_size
        self.lstm1 = Pew_LSTM_layer_shift_2(in_dim * window_size, hidden_dim, weather_dim * window_size, day_shift=day_shift)
        self.lstm2 = Pew_LSTM_layer_shift_2(hidden_dim, hidden_dim, weather_dim * window_size, day_shift=day_shift)
