...
class Pew_LSTM(nn.Module):
    ...
    def __init__(self, in_dim: int, hidden_dim: int, weather_dim: int, window_size: int = 30):
        ...
        self.lstm1 = Pew_LSTM_layer(in_dim * window_size, hidden_dim, weather_dim * window_size)
        self.lstm2 = Pew_LSTM_layer(hidden_dim, hidden_dim, weather_dim * window_size)
