...
from .internal.pew_lstm_ts import Pew_LSTM_TS
from sklearn.metrics import precision_score, accuracy_score
from .internal.model_util import model_util


class LSTM_V1_TS(pl.LightningModule):
    def __init__(self, in_dim, weather_dim, input_dim_3, hidden_dim=10, window_size=1, pos_weight=1):
        super(LSTM_V1_TS, self).__init__()
        self.lstm = Pew_LSTM_TS(in_dim=in_dim, hidden_dim=hidden_dim, weather_dim=weather_dim, window_size=window_size)
