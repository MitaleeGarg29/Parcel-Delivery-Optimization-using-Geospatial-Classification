...
version = "4"                       # local trained version of the model; needed for prediction and evaluation
...
if action == "train":
    ...
    test_presence_prediction = presence_prediction(
        ...
        data_time_shift="3:0",      # ensure that one version of a model always uses the same shift for training, predictions, and evaluation
